	...
	<div class="login-page">
         <div class="form">
            ...
            <div class="col-3"><br></div> 
             ...
             <form class="Login-form" name="myForm" action="vehicleownerregister"  onsubmit="return validate()" method="post">
                 <span id="usernameerror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="text" name="userName"  placeholder="User Name" id="username" autocomplete="off"/>
                 
                 <span id="fnameerror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="text" name="firstName"  placeholder="First Name" id="fname" autocomplete="off"/>
                 
                 <span id="lnameerror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="text" name="lastName"  placeholder="Last Name"  id="lname" autocomplete="off"/>
                 
                 
                 <span id="mobileerror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="text" name="mobNo"  placeholder="Mobile No"  id="mobile" autocomplete="off"/>
                 
                 <span id="emailiderror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="text" name="emailId" placeholder="Email Id"  id="emailid" autocomplete="off"/>
                 
                 <span id="passworderror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="Password" name="password"  placeholder="PassWord"  id="password" autocomplete="off"/>
                 
                 <span id="addresserror" class="text-danger font-weight-bold"></span>
                 <input style="border-radius: 4px;" type="text" name="address"  placeholder="Address"  id="address" autocomplete="off"/>
                 
                  <input type="text"  name="role" value="vehicleowner"  hidden="true"/>
